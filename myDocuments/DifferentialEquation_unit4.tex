...
The spring mass, damping, k--
spring constant-- then you divide out by m
and you get this-- you're familiar with that.
...
So omega 0 is the natural, undamped frequency.
If this term were not there that omega 0
...
because this k, to be converted into--
...
in recitation-- there was the natural--
...
if you have 0 on the right-hand side
but have damping, the function isn't periodic, it decays,
does this.
Nonetheless, it still crosses the x-axis at regular
intervals--
I'm sorry, it crosses the t-axis at regular intervals,
and therefore almost everybody just
casually refers to it as the frequency
and understands it's the natural damped frequency.
Now, the relation between them is
given by the little picture I drew you once,
but I didn't emphasize it enough.
Here is omega 0.
Here is a right angle.
This side is omega 1 and this side is the damping.
...
and therefore the smaller omega 1 is.
...
well then you'll make omega 1 almost the same size as omega
0--
...
So the relation between them is that omega 1 squared
is equal to omega 0 squared minus p squared,
...
and that I'm asking you about on the problem set is--
...
Let's-- x--
I don't care.
I switched to y's, as I'm in a y mode.
So our equation looks like this, just
as it did before, except now I'm going
to drive that with an undetermined frequency,
cosine omega t.
...
so I'm giving you a specific values of p and omega 0.
...
Omega 1 is the square root of omega 0
squared minus p squared.
What would you expect?
Well, what I would expect is that omega r should be omega 1.
The damped system has a natural frequency, omega 1.
The resonant frequency should be the same
as that natural frequency with which the damped system wants
to do it's thing.
And the answer is that's not right, it is the square root--
it's a little lower, it is omega 0 squared minus 2p squared.
